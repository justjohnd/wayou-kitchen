...
exports.addRecord = async (req, res) => {
  try {
    ...
    db_connect
      .collection("records")
      .insertOne(newRecord, function (err, response) {
        if (err) throw err;
        res.json(response);
      });
  } catch (error) {
...
exports.updateRecord = async (req, res) => {
  ...
  try {
    ...
    if (myObj.image === undefined && returnedDocument.image) {
      myObj.image = returnedDocument.image;
    }
...
exports.deleteRecord = async (req, res) => {
  try {
    ...
    returnDocument(db_connect, myQuery).then((returnedDocument) => {
      ...
      db_connect
        .collection("records")
        .deleteOne(myQuery, function (err, response) {
          if (err) throw err;
